# Google_GenerativeAI SDK (Unofficial)

This project now uses the **Google_GenerativeAI 3.6.3** SDK in place of the official Google.GenAI package. For current usage and examples, see `README-Google_GenerativeAI.md`. The remainder of this file is retained as historical reference for the older SDK.
